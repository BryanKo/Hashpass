...
public class activeCurrent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_active_current);

        businessName = (TextView) findViewById(R.id.tvActiveName);
        businessLoc = (TextView) findViewById(R.id.tvActiveLoc);
        businessRating = (TextView) findViewById(R.id.tvActiveRating);
        businessPrice = (TextView) findViewById(R.id.tvActivePrice);
        businessDist = (TextView) findViewById(R.id.tvActiveDist);

...
public class indoorCurrent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indoor_current);

        businessName = (TextView) findViewById(R.id.tvIndoorName);
        businessLoc = (TextView) findViewById(R.id.tvIndoorLoc);
        businessRating = (TextView) findViewById(R.id.tvIndoorRating);
        businessPrice = (TextView) findViewById(R.id.tvIndoorPrice);
        businessDist = (TextView) findViewById(R.id.tvIndoorDist);

...
/**
 * Created by Deepak Sharma on 11/17/2017.
 */

class weatherCurrent extends AppCompatActivity implements
    ...
    String Latitude = Double.toString(ax);
    String Longitude = Double.toString(ay);
